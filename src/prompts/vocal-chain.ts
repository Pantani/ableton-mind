...
export const vocalChainPrompt: PromptDefinition = {
  ...
  handler: ({ track_index = "0", style = "pop" }) => {
    const styleHints: Record<string, string> = {
      ...
      pop: "Comp ratio 4:1, threshold -20. Bright EQ shelf @ 10 kHz +2 dB. Predelay 20 ms on reverb.",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "   - For dynamic de-ess: link a Compressor with internal sidechain EQ @ 6-8 kHz.",
              "",
              "4. **Send to reverb:** if a Return track has reverb, use `track.set_volume` to open the appropriate send.",
              "",
