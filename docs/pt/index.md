...
features:
  ...
  - icon: 📦
    ...
    details: Source install, npm, GitHub Release .mcpb, Docker build e MCP Registry estao prontos para 0.1.0; Glama tem listagem, mas o release hospedado passa por um fluxo admin separado.
---
...
Os gates de validacao estao verdes para `0.1.0`, incluindo typecheck, lint, testes, build, `.mcpb`, docs build, dry-runs de package e doctor. npm, GitHub Release `.mcpb` e MCP Registry estao publicados. Glama tem listagem, mas o release hospedado exige o fluxo admin Deploy -> Make Release da Glama; indexacao da Smithery e disponibilidade de ghcr.io devem ser verificadas por canal. TD-030, smoke de hardware Push 2/3, continua bloqueado ate existir hardware fisico disponivel.
